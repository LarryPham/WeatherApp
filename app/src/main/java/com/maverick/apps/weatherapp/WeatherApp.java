...
import com.maverick.apps.weatherapp.service.tasks.WeakHandler;
...
public class WeatherApp extends Application {
  ...
  public static final String TAG = Properties.PREFIX + WeatherApp.class.getSimpleName();

  static class AppMainHandler extends WeakHandler {
